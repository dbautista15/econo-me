...
const ExpenseTracker = ({
	...
	const { categories, loading: categoriesLoading } = useCategories();//using this instead of the props
	...
	// Setting the default categories once the categoriesa re loaded
	useEffect(() => {
	...
	const handleAddExpense = async (e) => {
		...
		try {
			...
			// Reset form
			setCategory(['Food', 'Transportation', 'Housing', 'Utilities', 'Entertainment', 'Healthcare', 'Dining Out', 'Shopping']);
			setAmount('');
